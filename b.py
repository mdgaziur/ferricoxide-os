...
def link_everything():
    ...
    linker_script = f"./kernel/arch/{ferricoxide_architecture}/boot/linker.ld"
...
def make_iso():
    ...
    shutil.copy(f"kernel/arch/{ferricoxide_architecture}/boot/grub/grub.cfg", f"build/{ferricoxide_architecture}/iso_tree/boot/grub")
